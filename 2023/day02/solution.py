...
def execute():
    ...
    with open(input_file_path, "r") as f:
        ...
        for line in f:
            ...
            '''
            Split to isolate subsets
            With regex, find green, red, blue amounts. the order in which they
            are listed is random.
            Part1:
                compare amounts to maximum expected values. If game fits the
                expected values, add id to possible_game_id_list.
            Part2:
            ...
            Results:
                - sum of the ids of all games possible with only 12 red cubes,
